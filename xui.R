shinyUI(pageWithSidebar(
    headerPanel("CMCB qKinetics"),
    
    sidebarPanel(
        helpText("Analyse bacterial growth curves, including interactive plotting of growth curves, estimating of curve parameters and comparing curve parameters of different groups."),
